...
|                            [aerc](https://sr.ht/~rjarry/aerc) | just another email client          |
...
|                [discordo](https://github.com/ayn2op/discordo) | tui for discord                    |
|                     [tuir](https://gitlab.com/Chocimier/tuir) | tui for reddit (needs api)         |
...
|                                     [obsidian](https://obsidian.md) | second brain as notes                                       |
|                                      [spotify](https://spotify.com) | good music streamer                                         |
|                                  [spicetify](https://spicetify.app) | modder for spotify                                          |
|                  [easyeffects](https://github.com/wwmm/easyeffects) | audio equalizer/filtering/postproccessing                   |
...
|                       [blender](https://github.com/blender/blender) | modeling/render/video editing all in one                    |
| [davinci](https://www.blackmagicdesign.com/products/davinciresolve) | photocorrection/audio/video editing                         |
...
|         [portablemc](https://github.com/mindstorm38/portablemc) | cubics via cli                          |
|                                                        via wine |                                         |
| [umu-run](https://github.com/Open-Wine-Components/umu-launcher) | perfect cli proton launcher             |
|                      [lutris](https://github.com/lutris/lutris) | multi-launcher for linux                |
|                         [steam](https://store.steampowered.com) | cool game store and launcher            |
|                [r2modman](https://github.com/ebkr/r2modmanPlus) | mod manager for games                   |
|                [legendary](https://github.com/derrod/legendary) | cli for Epic Games Store                |

|                                                     services |                                       |
| -----------------------------------------------------------: | :------------------------------------ |
|      [suwayomi](https://github.com/Suwayomi/Suwayomi-Server) | tachiyomi on desktop                  |
|                           [tailscale](https://tailscale.com) | vpn? idk                              |
|           [torrserver](https://github.com/YouROK/TorrServer) | torrents stream server                |
| [transmission](https://github.com/transmission/transmission) | torrents) shit                        |
...
|              [clamav](https://github.com/Cisco-Talos/clamav) | antivirus                             |
|                     [mako](https://github.com/emersion/mako) | Notifications                         |
|                  [zapret](https://github.com/bol-van/zapret) | dpi avoider                           |
